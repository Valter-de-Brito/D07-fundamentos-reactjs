...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      const getAllTransactions = await api.get('/transactions');
      const getBalance = getAllTransactions.data.balance;
      const getTransactions = getAllTransactions.data.transactions;
